...
setup(
  ...
  url = 'https://github.com/weynelucas/interage_python_sdk',
  download_url = 'https://github.com/weynelucas/interage_python_sdk/archive/0.1.0.tar.gz',
  keywords = ['sdk', 'interage', 'api', 'intmed'],
  classifiers = [],
)
